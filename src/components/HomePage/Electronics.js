...
const Electronics = () => {
    ...
    // Fetch electronics products from Firestore on component mount
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const productRef = collection(db, "Product");
                // Query Firestore for products where category is 'electronics'
                const q = query(productRef, where("category", "==", "electronics"));
