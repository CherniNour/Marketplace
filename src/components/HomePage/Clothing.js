...
const Clothing = () => {
    ...
    // Fetch clothing products from Firestore on component mount
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const productRef = collection(db, "Product");
                // Query Firestore for products where category is 'clothing'
                const q = query(productRef, where("category", "==", "clothing"));
